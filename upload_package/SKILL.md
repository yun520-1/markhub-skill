...
- **📁 Cross-Platform Output** - Auto-saves to `~/Pictures/MarkHub/` (Windows/Linux/macOS)
...
# Output auto-saved to: ~/Pictures/MarkHub/markhub_beauty.png
```
...
- **Default Directory:** `~/Pictures/MarkHub/`
- **Cross-Platform:** Windows / Linux / macOS compatible
- **Auto-Create:** Directory created automatically if not exists
