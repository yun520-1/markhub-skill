...
Generate a structured JSON file in `/Users/apple/.jvs/.openclaw/workspace/` with naming pattern: `{descriptive-name}.json`

### Step 3: Execute Generation

Call the Python script:
```bash
python ~/.jvs/.openclaw/workspace/skills/image-generation/scripts/generate.py \
  --prompt-file /Users/apple/.jvs/.openclaw/workspace/prompt-file.json \
  --reference-images /path/to/ref1.jpg /path/to/ref2.png \
  --output-file /Users/apple/.jvs/.openclaw/workspace/outputs/generated-image.jpg
  --aspect-ratio 16:9
```
...
Create prompt file: `/Users/apple/.jvs/.openclaw/workspace/asian-woman.json`
```json
{
  "characters": [{
    "gender": "female",
...
```bash
python ~/.jvs/.openclaw/workspace/skills/image-generation/scripts/generate.py \
  --prompt-file /Users/apple/.jvs/.openclaw/workspace/cyberpunk-hacker.json \
  --output-file /Users/apple/.jvs/.openclaw/workspace/outputs/cyberpunk-hacker-01.jpg \
  --aspect-ratio 2:3
```
...
```bash
python ~/.jvs/.openclaw/workspace/skills/image-generation/scripts/generate.py \
  --prompt-file /Users/apple/.jvs/.openclaw/workspace/star-wars-scene.json \
  --reference-images /Users/apple/.jvs/.openclaw/workspace/uploads/character-ref.jpg /Users/apple/.jvs/.openclaw/workspace/uploads/vehicle-ref.jpg \
  --output-file /Users/apple/.jvs/.openclaw/workspace/outputs/star-wars-scene-01.jpg \
  --aspect-ratio 16:9
```
...
- Images are typically saved in `/Users/apple/.jvs/.openclaw/workspace/outputs/`
