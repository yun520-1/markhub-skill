...
```bash
python ~/.jvs/.openclaw/workspace/skills/video-generation/scripts/generate.py \
  --prompt-file /Users/apple/.jvs/.openclaw/workspace/prompt-file.json \
  --reference-images /path/to/ref1.jpg \
  --output-file /Users/apple/.jvs/.openclaw/workspace/outputs/generated-video.mp4 \
  --aspect-ratio 16:9
```
...
```bash
python ~/.jvs/.openclaw/workspace/skills/video-generation/scripts/generate.py \
  --prompt-file /Users/apple/.jvs/.openclaw/workspace/narnia-farewell-scene.json \
  --reference-images /Users/apple/.jvs/.openclaw/workspace/outputs/narnia-farewell-scene-01.jpg \
  --output-file /Users/apple/.jvs/.openclaw/workspace/outputs/narnia-farewell-scene-01.mp4 \
  --aspect-ratio 16:9
```
...
- Videos are typically saved in `/Users/apple/.jvs/.openclaw/workspace/outputs/`
- Share generated videos (come first) with user as well as generated image if applicable
