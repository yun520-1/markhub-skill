...
- You don't need to check the folder under `/Users/apple/.jvs/.openclaw/workspace`

### Step 2: Create Presentation Plan

Create a JSON file in `/Users/apple/.jvs/.openclaw/workspace/workspace/` with the presentation structure. **Important**: Include the `style` field to define the overall visual consistency.
...
1. Read the image-generation skill: `~/.jvs/.openclaw/workspace/skills/public/image-generation/SKILL.md`
...
```bash
python ~/.jvs/.openclaw/workspace/skills/public/image-generation/scripts/generate.py \
  --prompt-file /Users/apple/.jvs/.openclaw/workspace/workspace/slide-01-prompt.json \
  --output-file /Users/apple/.jvs/.openclaw/workspace/outputs/slide-01.jpg \
  --aspect-ratio 16:9
```
...
```bash
python ~/.jvs/.openclaw/workspace/skills/public/image-generation/scripts/generate.py \
  --prompt-file /Users/apple/.jvs/.openclaw/workspace/workspace/slide-02-prompt.json \
  --reference-images /Users/apple/.jvs/.openclaw/workspace/outputs/slide-01.jpg \
  --output-file /Users/apple/.jvs/.openclaw/workspace/outputs/slide-02.jpg \
  --aspect-ratio 16:9
```
...
python ~/.jvs/.openclaw/workspace/skills/public/image-generation/scripts/generate.py \
  --prompt-file /Users/apple/.jvs/.openclaw/workspace/workspace/slide-03-prompt.json \
  --reference-images /Users/apple/.jvs/.openclaw/workspace/outputs/slide-02.jpg \
  --output-file /Users/apple/.jvs/.openclaw/workspace/outputs/slide-03.jpg \
  --aspect-ratio 16:9

# Slide 4 references slide 3
python ~/.jvs/.openclaw/workspace/skills/public/image-generation/scripts/generate.py \
  --prompt-file /Users/apple/.jvs/.openclaw/workspace/workspace/slide-04-prompt.json \
  --reference-images /Users/apple/.jvs/.openclaw/workspace/outputs/slide-03.jpg \
  --output-file /Users/apple/.jvs/.openclaw/workspace/outputs/slide-04.jpg \
  --aspect-ratio 16:9
```
...
```bash
python ~/.jvs/.openclaw/workspace/skills/public/ppt-generation/scripts/generate.py \
  --plan-file /Users/apple/.jvs/.openclaw/workspace/workspace/presentation-plan.json \
  --slide-images /Users/apple/.jvs/.openclaw/workspace/outputs/slide-01.jpg /Users/apple/.jvs/.openclaw/workspace/outputs/slide-02.jpg /Users/apple/.jvs/.openclaw/workspace/outputs/slide-03.jpg \
  --output-file /Users/apple/.jvs/.openclaw/workspace/outputs/presentation.pptx
```
...
Create `/Users/apple/.jvs/.openclaw/workspace/workspace/ai-product-plan.json`:
```json
{
...
Read `~/.jvs/.openclaw/workspace/skills/public/image-generation/SKILL.md` to understand how to generate images.

### Step 3: Generate slide images sequentially with reference chaining

**Slide 1 - Title (establishes the visual language):**

Create `/Users/apple/.jvs/.openclaw/workspace/workspace/nova-slide-01.json`:
```json
{
...
```bash
python ~/.jvs/.openclaw/workspace/skills/public/image-generation/scripts/generate.py \
  --prompt-file /Users/apple/.jvs/.openclaw/workspace/workspace/nova-slide-01.json \
  --output-file /Users/apple/.jvs/.openclaw/workspace/outputs/nova-slide-01.jpg \
  --aspect-ratio 16:9
```

**Slide 2 - Content (MUST reference slide 1 for consistency):**

Create `/Users/apple/.jvs/.openclaw/workspace/workspace/nova-slide-02.json`:
```json
{
...
```bash
python ~/.jvs/.openclaw/workspace/skills/public/image-generation/scripts/generate.py \
  --prompt-file /Users/apple/.jvs/.openclaw/workspace/workspace/nova-slide-02.json \
  --reference-images /Users/apple/.jvs/.openclaw/workspace/outputs/nova-slide-01.jpg \
  --output-file /Users/apple/.jvs/.openclaw/workspace/outputs/nova-slide-02.jpg \
  --aspect-ratio 16:9
```
...
```bash
python ~/.jvs/.openclaw/workspace/skills/public/ppt-generation/scripts/generate.py \
  --plan-file /Users/apple/.jvs/.openclaw/workspace/workspace/nova-plan.json \
  --slide-images /Users/apple/.jvs/.openclaw/workspace/outputs/nova-slide-01.jpg /Users/apple/.jvs/.openclaw/workspace/outputs/nova-slide-02.jpg /Users/apple/.jvs/.openclaw/workspace/outputs/nova-slide-03.jpg /Users/apple/.jvs/.openclaw/workspace/outputs/nova-slide-04.jpg /Users/apple/.jvs/.openclaw/workspace/outputs/nova-slide-05.jpg \
  --output-file /Users/apple/.jvs/.openclaw/workspace/outputs/nova-presentation.pptx
```
...
- The PPTX file is saved in `/Users/apple/.jvs/.openclaw/workspace/outputs/`
